...
Promise.race([descarga1, descarga2, descarga3]).then((ganador) => console.log(ganador + " (fue el primero en completarse)"));
Promise.all([descarga1, descarga2, descarga3]).then(() => console.log("Todas las descargas completadas"));
